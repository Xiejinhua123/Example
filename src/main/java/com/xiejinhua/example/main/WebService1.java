 ...
 * 
 */
@WebServiceClient(name = "WebService1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://192.168.19.157:8080/WebService.asmx?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.19.157:8080/WebService.asmx?WSDL");
